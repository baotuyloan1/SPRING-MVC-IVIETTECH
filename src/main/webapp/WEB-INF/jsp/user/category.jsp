                                    ...
                                    <ul class="list">
                                        ...
                                        <c:if test="${producers!=null || fn:length(producers)>0}">
                                            <c:forEach var="producer" items="${producers}">
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/findProductByProducer/${producer.id}">${producer.name}</a>
                            ...
                            <div class="col-lg-12">
                                <div class="product_top_bar d-flex justify-content-between align-items-center">
                                    <div class="single_product_menu">
                                        <p><span>${product_found}</span> Product Found</p>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="single_product_item">
                                            <a href="<c:url value="/view-detail/${product.id}"/>">
                                                <img src="/resources/img/products/${product.images[0].name}" style="width:100%;"></img>
                                                <div class="single_product_text">
                                                    <h4>${product.name}</h4>
                                                    <h3>   ${product.price}00đ	</h3>
                                            </a>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <c:forEach var = "i" begin = "1" end = "${totalPage}">
                                            <li class="page-item"><a class="page-link" href="<c:url value="/category/${i-1}"/>"><c:out value = "${i}"/></a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="section_tittle text-center">
                        <h2>Best Coffee <span>shop</span></h2>
                    </div>
                </div>
            </div>
                        ...
                        <c:if test="${products!=null || fn:length(products)>0}">
                            <c:forEach var="product" items="${products}">
                                <a href="<c:url value="/view-detail/${product.id}"/>">
                                    ...
                                    <div class="single_product_item">
                                        <img src="/resources/img/products/${product.images[0].name}" alt="">
                                        <div class="single_product_text">
                                            <h4>${product.name}</h4>
                                            <h3> ${product.price}00 VNĐ	</h3>
                                        </div>
                                    </div>
                                </a>
